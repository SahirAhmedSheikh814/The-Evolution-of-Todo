          ...
          {loading ? (
             <div className="space-y-8">
              <div className="text-center mb-8">
                {/* Title Skeleton */}
                <Skeleton className="h-10 w-3/4 mx-auto bg-white/5 mb-3" />
                {/* Subtitle Skeleton */}
                <Skeleton className="h-5 w-2/3 mx-auto bg-white/5" />
              </div>

              {/* Card Skeleton - slightly taller for register form */}
              <Skeleton className="h-[500px] w-full rounded-2xl bg-white/5" />
            </div>
          ) : (
             <>
                <div className="text-center mb-8">
                  <h1 className="text-4xl font-bold mb-3 text-foreground">Create your account</h1>
